"""
捕获持久化存储 (SQLite) — B站捕获版
======================================
每次捕获自动存入 SQLite, 支持服务重启后恢复历史记录。
...
def save_capture(url, title, markdown="", plain_text="",
                 content_type="webpage", metadata=None,
                 captured_via="extension") -> str:
